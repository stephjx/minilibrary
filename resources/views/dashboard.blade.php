        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-white rounded-2xl shadow-md p-6 border border-gray-200 hover:shadow-2xl hover:border-blue-300 hover:scale-105 transition-all duration-300 cursor-pointer" style="transition: all 0.3s ease;">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="text-xs font-bold text-blue-700 bg-blue-100 px-3 py-1.5 rounded-full border border-blue-300 shadow-sm" style="background-color: #dbeafe; color: #1d4ed8; border-color: #93c5fd;">
    @if($studentsGrowth > 0)
        +{{ $studentsGrowth }}%
    @elseif($studentsGrowth < 0)
        {{ $studentsGrowth }}%
    @else
        0%
    @endif
            ...
            <div class="bg-white rounded-2xl shadow-md p-6 border border-gray-200 hover:shadow-2xl hover:border-green-300 hover:scale-105 transition-all duration-300 cursor-pointer" style="transition: all 0.3s ease;">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="text-xs font-bold text-green-700 bg-green-100 px-3 py-1.5 rounded-full border border-green-300 shadow-sm" style="background-color: #dcfce7; color: #15803d; border-color: #86efac;">
    @if($booksGrowth > 0)
        +{{ $booksGrowth }}%
    @elseif($booksGrowth < 0)
        {{ $booksGrowth }}%
    @else
        0%
    @endif
            ...
            <div class="bg-white rounded-2xl shadow-md p-6 border border-gray-200 hover:shadow-2xl hover:border-yellow-300 hover:scale-105 transition-all duration-300 cursor-pointer" style="transition: all 0.3s ease;">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="text-xs font-bold text-yellow-700 bg-yellow-100 px-3 py-1.5 rounded-full border border-yellow-300 shadow-sm" style="background-color: #fef3c7; color: #a16207; border-color: #fde047;">
    @if($borrowsGrowth > 0)
        +{{ $borrowsGrowth }}%
    @elseif($borrowsGrowth < 0)
        {{ $borrowsGrowth }}%
    @else
        0%
    @endif
            ...
            <div class="bg-white rounded-2xl shadow-md p-6 border border-gray-200 hover:shadow-2xl hover:border-red-300 hover:scale-105 transition-all duration-300 cursor-pointer" style="transition: all 0.3s ease;">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="text-xs font-bold text-red-700 bg-red-100 px-3 py-1.5 rounded-full border border-red-300 shadow-sm" style="background-color: #fee2e2; color: #b91c1c; border-color: #fca5a5;">
    @if($overdueBorrows > 0)
        Alert
    @else
        Clear
