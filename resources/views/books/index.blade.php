<x-library-layout>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex items-center gap-3">
                                        <a href="{{ route('books.show', $book) }}" class="p-2 bg-blue-50 rounded-lg border border-blue-200 text-blue-600 hover:bg-blue-100 transition-colors" title="View Book">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" />
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                                            </svg>
                                        </a>
                                        <button onclick="openEditModal({{ $book->id }}, '{{ $book->title }}', '{{ $book->isbn }}', {{ $book->total_quantity }})" class="p-2 bg-green-50 rounded-lg border border-green-200 text-green-600 hover:bg-green-100 transition-colors" title="Edit Book">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" />
                                            </svg>
                                        </button>
                                        <button onclick="openDeleteModal({{ $book->id }}, '{{ $book->title }}')" class="p-2 bg-red-50 rounded-lg border border-red-200 text-red-600 hover:bg-red-100 transition-colors" title="Delete Book">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-12 text-center text-gray-500">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-lg font-medium text-gray-600 mb-1">No books found</p>
                                        <p class="text-sm text-gray-400">Get started by adding your first book</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
            ...
            @if ($books->hasPages())
                <div class="px-6 py-4 border-t border-gray-200">
                    @include('pagination', ['paginator' => $books])
                </div>
            @endif
        </div>
    ...
    <!-- Edit Modal (Simple JavaScript Version) -->
    <div id="editModal" class="fixed inset-0 bg-gray-900 bg-opacity-50 z-50 hidden" onclick="closeEditModal(event)">
        <div class="flex min-h-full items-center justify-center p-4">
            <div class="relative bg-white rounded-xl shadow-xl max-w-md w-full" onclick="event.stopPropagation()">
                ...
                <form id="editForm" method="POST" class="p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <label for="edit_total_quantity" class="block text-sm font-medium text-gray-700 mb-1">
                ...
                <div class="p-6">
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-sm text-gray-500 mb-4">
                            Do you really want to delete <span id="deleteBookTitle" class="font-semibold text-gray-900"></span>? This action cannot be undone.
                        </p>
                    </div>
                </div>
    ...
    <script>
        ...
        function openEditModal(bookId, title, isbn, totalQuantity) {
